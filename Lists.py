...
"""
# ----------------------------------------------------------------------------------------------------------------------
stringVar = ["Matthew", "Mark", "Luke", "John"]
intVar = [28, 26, 20]
mixVar = [89, "Novel", True, 74, "Bible"]
print(stringVar[:])
print(intVar[1])
print(mixVar[2])
...
"""
# ----------------------------------------------------------------------------------------------------------------------
varNew = ["Bob Dylan", "Like a", "Rolling Stone"]
print(varNew.index("Rolling Stone"))
varNew.insert(0, 1965)
print(varNew)
# ----------------------------------------------------------------------------------------------------------------------
"""
.remove() and .pop()
...
"""
# ----------------------------------------------------------------------------------------------------------------------
varNew1 = ["McCartney", "Lennon", "Starr", "Harrison", "Sutcliffe"]
varNew1.remove("Sutcliffe")
print(varNew1)
varNew2 = varNew1.pop(1)
varNew3 = varNew1.pop(2)
print(varNew1,"\n", varNew2, "\n", varNew3)
